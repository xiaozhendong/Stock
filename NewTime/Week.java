...
import edu.dlnu.liuwenpeng.NewTime.*;
...
public class Week extends RegularTimePeriod implements Serializable {
	...
	public void setWeek(int week, Year year) {
		if ((week < FIRST_WEEK_IN_YEAR) && (week > LAST_WEEK_IN_YEAR)) {
			throw new IllegalArgumentException(
					"The 'week' argument must be in the range 1 - 53.");
		}
	...
	public void setWeek(Date time, TimeZone zone, Locale locale) {
		if (time == null) {
			throw new IllegalArgumentException("Null 'time' argument.");
		}
		if (zone == null) {
	...
	public void setWeek(Date time, TimeZone zone) {
		// defer argument checking...
		setWeek(time, zone, Locale.getDefault());
	}
	
	public void  setWeek(Date time) {
		// defer argument checking...
		setWeek(time, RegularTimePeriod.DEFAULT_TIME_ZONE, Locale.getDefault());
	}
	/**
