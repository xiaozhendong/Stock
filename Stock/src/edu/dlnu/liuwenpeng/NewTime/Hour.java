...
public class Hour extends RegularTimePeriod implements Serializable {
	...
	public void setHour(Date time, TimeZone zone) {
		if (time == null) {
			throw new IllegalArgumentException("Null 'time' argument.");
		}
		if (zone == null) {
	...
	public void setHour(int hour, int day, int month, int year) {
		setHour(hour, new Day(day, month, year));
	}
	
	
	public void setHour(int hour, Day day) {
		if (day == null) {
			throw new IllegalArgumentException("Null 'day' argument.");
		}
		this.hour = (byte) hour;
	...
	public void setHour(Date time) {
		// defer argument checking...
		setHour(time, RegularTimePeriod.DEFAULT_TIME_ZONE);
	}
	/**
